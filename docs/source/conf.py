...
# odsl_sn_1_dist_sent_jud documentation build
...
from odsl_sn_1_dist_sent_jud import __version__ as release

# -- Project information -----------------------------------------------------

project = "odsl_sn_1_dist_sent_jud"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "odsl_sn_1_dist_sent_juddoc"
...
latex_documents = [
    (
        master_doc,
        "odsl_sn_1_dist_sent_jud.tex",
        "odsl_sn_1_dist_sent_jud Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "odsl_sn_1_dist_sent_jud",
        "Project odsl_sn_1_dist_sent_jud codebase.",
        "Data-Science",
    )
]
